...
test('Parent Contacts PLG', async ({ page }, testInfo) => {
  ...
  const screenshotPath = path.join(screenshotDir, `ParentContactsPLG_ContactDetails_${timestamp}.png`);
  await page.screenshot({ path: screenshotPath, fullPage: true });
  console.log('Parent Contacts PLG Contact Details screenshot saved at: ' + screenshotPath);
